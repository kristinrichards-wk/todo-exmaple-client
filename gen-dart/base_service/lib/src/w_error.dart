 ...
 *  @generated
 */
library base_service.src.w_error;
...
class WError extends Error implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("WError");
  static final TField _CODE_FIELD_DESC = new TField("code", TType.I64, 1);
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("WError(");
